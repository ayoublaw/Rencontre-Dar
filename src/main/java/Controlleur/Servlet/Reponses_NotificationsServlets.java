...
@WebServlet(name = "Reponses_NotificationsServlets",urlPatterns = "/NotificationsResponse")
public class Reponses_NotificationsServlets extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            ...
            List<Evenement> list = even.GetAllReponsesProposition(usercurrent);
