...
@WebServlet(name = "ListEvenementCanParticipateServlet",urlPatterns = "/CanPartcicipate")
public class ListEvenementCanParticipateServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            ...
            List<Evenement> list = even.ListEvenementCanParticipate(user);
