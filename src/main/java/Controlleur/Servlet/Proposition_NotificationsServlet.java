...
@WebServlet(name = "Proposition_NotificationsServlet",urlPatterns = "/NotificatonsPropositions")
public class Proposition_NotificationsServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            ...
            List<Evenement> list = even.GetAllProposition(usercurrent);
